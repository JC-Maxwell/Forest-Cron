...
# MODE PROCESESS:
PROCESS_LOGS = {}
PROCESS_LOGS[EQUALIZATION] = '/Equalization/Threads/eqdb-1.log'
PROCESS_LOGS[SYNCHRONIZATION] = '/SL1/Threads/sl1-1.log'
PROCESS_LOGS[INITIALIZATION] = '/Initialization/Threads/init-1.log'
PROCESSES_RUN_MODE = {
	'1' : [EQUALIZATION,SYNCHRONIZATION,INITIALIZATION],
	'2' : [SYNCHRONIZATION,INITIALIZATION]
}

DEFAULT_SERVERS = {
	'1' : True,
	'2' : True
}#End of DEFAULT_SERVERS
